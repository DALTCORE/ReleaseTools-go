...
$ mkdir -p ~/bin \
  ...
  https://github.com/DALTCORE/ReleaseTools-go/releases/download/1.2.3/release-tool-darwin-amd64 \
...
$ mkdir -p ~/bin \
  ...
  https://github.com/DALTCORE/ReleaseTools-go/releases/download/1.2.3/release-tool-linux-amd64 \
...
## Windows
1. Download [release-tool-windows-amd64.exe](https://github.com/DALTCORE/ReleaseTools-go/releases/download/1.2.3/release-tool-windows-amd64.exe)
